...
namespace Microsoft.Extensions.FileSystemGlobbing
{
    ...
    ///             to <see cref="Execute(DirectoryInfo)" />
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
    class Matcher
    {
        ...
        ///     directory given when <see cref="Execute(DirectoryInfo)" /> is called.
        ///     </para>
        ///     <para>
        ...
        ///     root directory given when <see cref="Execute(DirectoryInfo)" /> is called.
        ///     </para>
        ///     <para>
        ///     Use the forward slash '/' to represent directory separator. Use '*' to represent wildcards in file and
        ///     directory names. Use '**' to represent arbitrary directory depth. Use '..' to represent a parent directory.
